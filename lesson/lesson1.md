...
- Реализуйте класс `main.java.storage.ArrayStorage`, организовав хранение резюме на основе массива с методами `save, get, delete, size, clear, getAll`
...
```
- Протестируйте вашу реализацию с помощью классов `main.java.MainArray.main()` и `main.java.MainTestArrayStorage.main()`
...
6. `main.java.model.Resume r` — давай переменным осмысленные имена, например `resume`. `r` допустимо в коротких циклах и лямбдах.
...
1. Не меняйте сигнатуры методов в `main.java.storage.ArrayStorage`
